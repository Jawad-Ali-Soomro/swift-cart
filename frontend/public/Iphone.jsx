...
Command: npx gltfjsx@6.2.16 iphone-15/iphone.gltf 
...
export default function Model(props) {
  const { nodes, materials } = useGLTF('./iphone-15/iphone.gltf')
  return (
    <group {...props} dispose={null}>
      <group scale={0.01}>
        <group scale={500}>
          ...
          <mesh geometry={nodes.Camera_Camera_Frame001_0.geometry} material={materials['Camera_Frame.005']} />
...
useGLTF.preload('./iphone-15/iphone.gltf')
